          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <option value="cloud" className="text-white font-Kanit">
                  Software to Cloud
                </option>
                <option value="web" className="text-white font-Kanit">
                  Web Application
                </option>
                <option value="saas" className="text-white font-Kanit">
                  SaaS
                </option>
                <option value="mobile" className="text-white font-Kanit">
                  Mobile
                </option>
                <option value="others" className="text-white font-Kanit">
                  Others
                </option>
              </select>
            </div>
